...
This document outlines the processes and practices recommended for contributing enhancements to `kubeflow-roles`.
...
# Deploy the charm
juju deploy ./kubeflow-roles_ubuntu@24.04-amd64.charm --trust
```
